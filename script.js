...
function displayMovies(movieList,page){
    ...
    paginatedMovies.forEach(movie=>{
        const cardCon = document.getElementsByClassName("cardCon")[0];
        ...
        div.innerHTML = `
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" onclick="openModal(${movie.id})"  data-toggle="modal" data-target="#movieModal">More Info</button>
                </div>
        `;
